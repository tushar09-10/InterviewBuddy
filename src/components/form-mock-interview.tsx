  ...
  type FormData = z.infer<typeof formSchema>;
    ...
    const form = useForm<FormData>({
      ...
      { "question": "<Question text>", "answer": "<Answer text>" },
          ...
          try {
          const aiResult = await getChatSession(prompt, 5); // Increase max retries to 5 for better rate limit handling
          ...
          if (isRateLimit) {
          throw new Error("Rate limit exceeded. The app will automatically retry with increasing delays. If this persists, please wait 2-5 minutes before trying again.");
          ...
          errorDescription = "The app is automatically retrying with increasing delays. If this persists, please wait 2-5 minutes before trying again. This happens when too many requests are made to the AI service.";
